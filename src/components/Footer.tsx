          ...
          <div>
            ...
            <div className="flex gap-2">
              {["Twitter", "Facebook", "Instagram"].map((s) => (
                <span
                  key={s}
                  className="text-xs bg-white/5 px-3 py-1.5 rounded-lg hover:bg-penang-coral/20 hover:text-white transition-all duration-300 cursor-pointer text-gray-400"
                >
                  {s}
                </span>
              ))}
