...
const markers: MarkerData[] = [
  { pos: [5.4141, 100.3288], title: "ジョージタウン", desc: "世界遺産地区・ショップハウス・壁画", color: "#ff6b6b" },
  { pos: [5.4063, 100.2839], title: "極楽寺 (Kek Lok Si)", desc: "東南アジア最大の仏教寺院", color: "#ff6b6b" },
  { pos: [5.4118, 100.3382], title: "クラン・ジャッティ", desc: "水上集落", color: "#ff6b6b" },
  { pos: [5.4110, 100.3320], title: "リトル・インディア", desc: "スパイス香る街", color: "#ff6b6b" },
  { pos: [5.4135, 100.3370], title: "Pinang Peranakan Mansion", desc: "ババ・ニョニャ博物館", color: "#ff6b6b" },
  { pos: [5.4730, 100.2540], title: "バトゥ・フェリンギ", desc: "ペナン代表ビーチ", color: "#2d8a4e" },
  { pos: [5.4233, 100.2647], title: "ペナンヒル", desc: "パノラマ展望台", color: "#2d8a4e" },
  { pos: [5.4578, 100.2108], title: "ペナン国立公園", desc: "原生林・隠れビーチ", color: "#2d8a4e" },
